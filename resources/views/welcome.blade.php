        ...
        <div id="slideshow">
            ...
            @endphp
                <ul>
                    ...
                    <li data-transition="zoomin" data-slotamount="7" data-masterspeed="1500" class="item {{ $i==0 ? 'active' : '' }}">
                        <!-- MAIN IMAGE -->
                        <img src="public/uploads/slider/{{ $slide->slider_image }}" height="100" width="300">
                    </li>             
                    @endforeach
                </ul>
            </div>
