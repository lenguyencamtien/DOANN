                ...
                <div id="main">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                {{ csrf_field() }}
                                <div class="box_group_from">
                                    <input type="text" name="customer_name" class="customer_name" placeholder="Họ và Tên" required="">
                                </div>
                                <div class="box_group_from">
                                    <input type="text" name="customer_phone" class="customer_phone" placeholder="Số điện thoại" required="">
                                </div>
                                <div class="box_group_from">
                                    <input type="text" name="customer_email" class="customer_email" placeholder="Email" required="">
                                </div>
                                <div class="box_group_from">
                                    <input type="password" name="customer_password" class="customer_password" placeholder="Mật khẩu" required="">
                                </div>
