            ...
            <div class="container">
                <div class="woocommerce">
                    ...
                    <!-- {{ csrf_field() }} -->
                        ...
                        <div class="form_nho">
                        <div class="box_group_from">
                            <input type="text" name="address" class="shipping_address" placeholder="Địa Chỉ" required="">
                        </div>
                        </div>
                        <div class="form_nho">
                        <div class="box_group_from">
                    ...
                    <div class="form_nho">
                    <div class="box_group_from">
                            <input type="text" name="name" class="shipping_email" placeholder="Email" required="">
                        </div>
                    </div>
                    <div class="form_nho">
                        <textarea name="content" class="shipping_note" placeholder="Ghi chú về đơn đặt hàng của bạn, ghi chú đặc biệt khi giao hàng" cols="60" rows="5" required=""></textarea>
                    </div>
                    <div class="form-row place-order">
                            <input type="button" value="Xác nhận đơn hàng" name="" class="btn btn-primary btn-sm send_order">
                    </div>
                        </form>
                                    </div>
                                    ...
                                    <div id="payment">
                                        ...
                                        <ul class="payment_methods methods box-sm">
                                            <li class="payment_method_bacs">
                                                <label class="radio">
                                                    <input id="payment_method_bacs" class="input-radio" name="payment_method" value="1" data-order_button_text="" type="radio">
                                                    Chuyển khoản 
                                                </label>
                                            </li>
