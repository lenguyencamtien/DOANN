                        ...
                        <ul class="header-top-nav">
                            ...
                            <li class="mini-search">
                                ...
                                <div class="main-nav-search-form">
                                    <form action="{{URL::to('/tim-kiem')}}" method="POST" role="search">
                                        {{ csrf_field() }}
                                        <div class="search-box">
                                            <input type="text" id="s" name="keywords_submit" value="">
...
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/css/themes/bootstrap.min.css"/>
    ...
    $(document).ready(function(){
        $('.send_order').click(function(){
            ...
            var shipping_method = $('input[name="payment_method"]:checked').val();
            var _token = $('input[name="_token"]').val();
            $.ajax({
                url: '{{url('/confirm-order')}}',
                type: "POST",
                data:{shipping_name:shipping_name,shipping_address:shipping_address,shipping_email:shipping_email,shipping_phone:shipping_phone,shipping_note:shipping_note,shipping_method:shipping_method,_token:_token},
                success: function(){
                    swal("Đơn hàng", "Đặt hàng thành công.", "success");
                }
            });
  } else {
    swal("Đóng", "Đặt hàng thất bại", "error");
  }
            });             
        });
    });
