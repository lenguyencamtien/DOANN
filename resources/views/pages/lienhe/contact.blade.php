                ...
                <form role="form" action="" method="" >
                    ...
                    <div class="form_nho">
                        <div class="box_group_from">
                            <input type="text" name="contact_name" placeholder="Tên Khách Hàng" required="">
                        </div>
                        <div class="box_group_from">
                    ...
                    <div class="form_nho">
                        <textarea name="contact_content" placeholder="Nội Dung" style="resize: none" rows="5" required=""></textarea>
                    </div>
